...
var TEXTE = {
  "en": {
    ...
    "help.actions": "S when · M move · E rename · X delete · C checklist",
  ...
  "ro": {
    ...
    "help.actions": "S când · M mută · E redenumește · X șterge · C listă",
  ...
  "de": {
    ...
    "help.actions": "S wann · M verschieben · E umbenennen · X löschen · C Checkliste",
  ...
  "fr": {
    ...
    "help.actions": "S quand · M déplacer · E renommer · X supprimer · C checklist",
  ...
  "es": {
    ...
    "help.actions": "S cuándo · M mover · E renombrar · X eliminar · C lista",
  ...
  "it": {
    ...
    "help.actions": "S quando · M sposta · E rinomina · X elimina · C checklist",
  ...
  "pt-BR": {
    ...
    "help.actions": "S quando · M mover · E renomear · X excluir · C checklist",
  ...
  "pl": {
    ...
    "help.actions": "S kiedy · M przenieś · E zmień nazwę · X usuń · C lista",
  ...
  "ru": {
    ...
    "help.actions": "S когда · M переместить · E переименовать · X удалить · C список",
  ...
  "zh-CN": {
    ...
    "help.actions": "S 时间 · M 移动 · E 重命名 · X 删除 · C 清单",
